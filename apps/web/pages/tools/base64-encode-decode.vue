<script setup lang="ts">
    ...
    if (!tool) throw new Error("Tool not found: base64-encode-decode");
        ...
        meta: [
            {
                name: "description",
                content:
                    "Encode and decode Base64 strings instantly in your browser. Supports text, files, and URL-safe Base64. Free tool with zero data uploads.",
            },
            ...
            },
            {
                ...
                content:
                    "Encode and decode Base64 strings instantly in your browser. Supports text, files, and URL-safe Base64.",
            },
