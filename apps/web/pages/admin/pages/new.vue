...
<template>
  <div>
    <div class="flex items-center justify-between mb-6">
      <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-50">New Page</h1>
      ...
      <div class="lg:col-span-7 space-y-4">
        <div class="bg-surface dark:bg-surface-dark border border-surface-border dark:border-surface-dark-border rounded-xl p-5 space-y-4">
          ...
          <div>
            ...
            <AdminMarkdownEditor v-model="form.content" placeholder="Write your content in Markdown..." />
          </div>
