...
<template>
  <div>
    <div v-if="loading" class="text-sm text-gray-500 dark:text-gray-400">Loading affiliate...</div>

    <template v-else>
      <div class="flex items-center justify-between mb-6">
        <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-50">Edit Affiliate</h1>
        <button
