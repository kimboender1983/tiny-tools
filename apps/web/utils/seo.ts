...
export function generateJsonLd(type: 'SoftwareApplication', data: SoftwareApplicationData): Record<string, unknown>;
export function generateJsonLd(type: 'FAQPage', data: FaqItem[]): Record<string, unknown>;
export function generateJsonLd(type: 'BreadcrumbList', data: BreadcrumbItem[]): Record<string, unknown>;
